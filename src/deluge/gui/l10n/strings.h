...
enum class String : size_t {
	...
	STRING_FOR_LOAD,
	STRING_FOR_VELOCITY_MIN,
	STRING_FOR_VELOCITY_MIN_SHORT,
	STRING_FOR_VELOCITY_MAX,
	STRING_FOR_VELOCITY_MAX_SHORT,
	STRING_FOR_VARIANT_VOLUME,
	STRING_FOR_VOLUME_SHORT,

	// strings for numbered choke groups
	STRING_FOR_COMMUNITY_FEATURE_CHOKE_GROUPS,
